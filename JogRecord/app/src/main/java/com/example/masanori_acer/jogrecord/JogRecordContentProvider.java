...
public class JogRecordContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.masanori_acer.jogrecord.JogRecordContentProvider";
    ...
    public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/jogrecord";
